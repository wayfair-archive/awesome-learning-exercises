      ...
      <div>
        <div aria-live="assertive" className="App">
          <div className="App-navWrapper">
            <h1>Awesome Learning: Accessibility for Multimedia</h1>
          ...
          <Switch>
            ...
            <Route
              component={() => (
                <p>
                  Welcome to Awesome Learning: Accessibility for Multimedia.
                  When you're ready to begin, click on "Exercise 1" in the above
                  navigation, and open{" "}
                  <b>
