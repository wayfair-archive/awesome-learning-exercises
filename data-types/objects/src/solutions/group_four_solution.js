...
These libraries prevent mutations of objects and allow the user to tightly control how and when an object changes, 
ultimately preventing commond logic mistakes.

Implement a function below preventMutation(obj) which makes sure that an object cannot be modified once the method is invoked.
*/
